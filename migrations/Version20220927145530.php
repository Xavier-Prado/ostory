...
final class Version20220927145530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE choice (id INT AUTO_INCREMENT NOT NULL, pages_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, page_id INT NOT NULL, INDEX IDX_C1AB5A92401ADD27 (pages_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, story_id INT DEFAULT NULL, title VARCHAR(128) NOT NULL, image VARCHAR(2083) NOT NULL, content LONGTEXT NOT NULL, start TINYINT(1) DEFAULT NULL, page_end LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_140AB620AA5D4036 (story_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
