...
final class Version20220929144140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, story_id INT DEFAULT NULL, title VARCHAR(128) NOT NULL, image VARCHAR(2083) NOT NULL, content LONGTEXT NOT NULL, start LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', pageEnd INT NOT NULL, INDEX IDX_140AB620AA5D4036 (story_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
